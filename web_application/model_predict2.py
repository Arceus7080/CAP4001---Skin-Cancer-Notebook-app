...
efficientnet_model = EfficientNetB0(input_shape=(100,100, 3), include_top=False, weights='efficientnet-b0_weights_tf_dim_ordering_tf_kernels_autoaugment_notop (1).h5')
